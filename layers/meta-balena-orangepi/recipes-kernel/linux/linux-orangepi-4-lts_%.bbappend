...
# SRC_URI_append_orangepi-4-lts = " file://0002-Revert-arm64-dts-rockchip-fix-Orange-Pi-4-device-alias.patch"

# spidev module is enabled by default in meta-balena,
# so let's enable the spidev overlay by default
# on the orangepi-4-lts.
do_deploy_append_orangepi-4-lts() {
...
BALENA_CONFIGS_append_orangepi-4-lts = " no-in-tree_wifi-no-rockchip-wl"
...
BALENA_CONFIGS_append_orangepi-4-lts = " backported-brcmfmac"
